      ...
      <Card>
        ...
        {unbilledIndicator && unbilledIndicator.count > 0 ? (
          <Link href="/billing/workspace" className="mt-4 block no-underline">
            <Card
              tone="danger"
              className="flex flex-wrap items-center justify-between gap-3 transition duration-200 hover:shadow-md hover:brightness-[0.98] motion-safe:hover:-translate-y-px"
            >
              <div>
